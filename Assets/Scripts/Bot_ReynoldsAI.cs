...
public class Bot_ReynoldsAI : MonoBehaviour
{
    ...
    private Exercise_4_Manager m_manager = null;
    ...
    void Start()
    {
        ...
        m_manager = gameObject.GetComponentInParent<Exercise_4_Manager>();
    ...
    void Update()
    {
        ...
        collision_avoidance = collision_avoidance - dot * forward;

        m_agent.set_velocity((m_direction +
            collision_avoidance
            ) * m_speed);
